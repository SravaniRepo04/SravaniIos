...
// Question 2
//print("2a: Cannot assign value of type 'Int' to type 'Double'")
...
var newStr = original.replacingOccurrences(of:"a", with: "*")
print(newStr)
...
for letters in str.reversed() {
    print(letters, terminator: "")
}
print()
print("------------------------------")
